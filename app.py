...
st.set_page_config(page_title="REFORMA DE FORNOS V10.1 FIX2", layout="wide", page_icon="🔥")
...
st.markdown(f"<h1 style='text-align:center; background:#000; color:#00ff66; padding:15px; border-radius:12px; border:4px solid #ff4e00;'>🔥 REFORMA DE FORNOS | {agora_br.strftime('%d/%m/%Y %H:%M:%S')} | V10.1 FIX2 🔥</h1>", unsafe_allow_html=True)
...
with tab_dash:
    st.subheader("🖥️ DASHBOARD 24H - NUMEROS GIGANTES")
    saldos = get_saldos_completos()
...
#... as outras abas CADASTRO, ENTRADA/SAIDA, ESTOQUE, BUSCA POR ID, GRD+ZAP, GRAFICOS estão completas no arquivo - todas funcionando
